...
As built most controls are exposed to the HomeAssistant front end, but this package can operate independently of HA, and, if the ESPNOW protol is used, doesn't even need a local WiFi AP to operate and has a very low idle current consumption.
